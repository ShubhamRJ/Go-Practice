...
func isValidInput(first string, last string, email string, tickets uint) (bool, bool, bool) {
...
func main() {
	...
	for {
		...
		var isValidName, isValidEmail, isValidTickets = isValidInput(userFirstName, userLastName, userEmail, userNumberOfTicket)
